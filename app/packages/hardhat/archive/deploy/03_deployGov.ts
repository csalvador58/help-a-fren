...
//  */
// const deployHelpAFrenGov: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
//   /*
...
//   const helpAFrenGovDeployedAddress = deployedHelpAFrenGov.address;
//   console.log("helpAFrenGovDeployedAddress: ", helpAFrenGovDeployedAddress);
...
// export default deployHelpAFrenGov;

// // Tags are useful if you have multiple deploy files and only want to run one of them.
// // e.g. yarn deploy --tags HelpAFrenGov
// deployHelpAFrenGov.tags = ["HelpAFrenGov"];
